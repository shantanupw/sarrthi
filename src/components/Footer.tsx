        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p><strong className="text-foreground">Phone:</strong> <a href="tel:+919569093856" className="hover:text-foreground transition-colors">+91 95690 93856</a></p>
              <p><strong className="text-foreground">Email:</strong> <a href="mailto:ask@sarrthi.com" className="hover:text-foreground transition-colors">ask@sarrthi.com</a></p>
            ...
            <div className="flex items-center gap-4">
              <a href="https://youtube.com/@sarrthi" className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href="https://instagram.com/sarrthi_ias" className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://linkedin.com/company/sarrthi-ias" className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://t.me/sarrthi_ias" className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-lg text-foreground">UPSC Courses</h4>
            <ul className="space-y-3">
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">GS Foundation 2026</a></li>
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">GS Foundation Plus</a></li>
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">Beginners Kit</a></li>
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">GS Mains Comprehensive</a></li>
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">Optional Subjects</a></li>
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">CSAT Preparation</a></li>
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">Test Series</a></li>
              <li><a href="/courses" className="text-muted-foreground hover:text-foreground transition-colors">All Courses</a></li>
            </ul>
          </div>
